...
#
# adl.test_indicator(m1_file_name, start_date_m1, end_date_m1, figure_title_m1, width_m1)
# adl.test_indicator(h1_file_name, start_date_h1, end_date_h1, figure_title_h1, width_h1)
# adl.test_indicator(d1_file_name, start_date_d1, end_date_d1, figure_title_d1, width_d1)
#
